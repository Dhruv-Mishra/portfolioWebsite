...
export const PROJECTS: ProjectRecord[] = [
  ...
  },
  {
    ...
    desc: (
      <>
        A <strong>high-performance</strong> portfolio website built with <span className="bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-1.5 py-0.5 rounded text-sm">Next.js 16</span>, centered on a <span className="text-rose-600 dark:text-rose-400 font-bold">native voice agent with full-site action access</span>. Visitors can talk naturally while it navigates pages, opens projects, controls media, changes preferences, and completes supported forms — not just answer questions. It pairs a <span className="underline decoration-wavy decoration-amber-400">self-hosted, grounded LLM chat</span> with a <strong>self-hosted TTS engine</strong>, an interactive terminal, and the site&apos;s <span className="italic">hand-drawn sketchbook aesthetic</span>. <span className="underline decoration-wavy decoration-indigo-400">Georedundant</span> across <span className="text-sky-600 dark:text-sky-400 font-semibold">Azure</span>, <span className="text-blue-600 dark:text-blue-400 font-semibold">GCP</span>, and <span className="text-orange-600 dark:text-orange-400 font-semibold">Oracle Cloud</span> VMs with custom traffic routing and parallel <span className="font-semibold">GitHub Actions</span> deployments — entirely free except the domain. Live at <a href="https://whoisdhruv.com" target="_blank" rel="noopener noreferrer" className="font-mono text-sm font-semibold text-indigo-700 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/50 px-1.5 py-0.5 rounded ring-1 ring-indigo-300/60 dark:ring-indigo-700/60 transition-colors hover:bg-indigo-200 dark:hover:bg-indigo-800/70 hover:ring-indigo-500 hover:text-indigo-900 dark:hover:text-indigo-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">whoisdhruv.com&nbsp;↗</a>.
      </>
    ),
    ...
    icon: Globe,
    label: 'This Website',
    stack: ['Next.js', 'TypeScript', 'Voice AI', 'Tool Calling', 'Self-Hosted LLM', 'Self-Hosted TTS', 'Multi-Cloud'],
    role: 'Full Stack',
    year: '2025',
    duration: 'Ongoing',
    highlights: [
      'Native voice agent with guarded full-site actions — navigation, project and media controls, preferences, and supported forms',
      'Self-hosted, retrieval-grounded LLM chat and self-hosted TTS engine',
      'Interactive terminal and hand-drawn sketchbook UI with a custom pencil/chalk cursor',
      'Georedundant deployment across Azure, GCP, and Oracle Cloud',
    ],
  },
  {
